      ...
      <div className="flex justify-center flex-wrap items-center px-6 py-12 max-w-6xl mx-auto ">
        ...
        <div className="w-full md:w-[67%] lg:w-[40%] lg:ml-20">
            ...
            <input className="w-full px-4 py-2 text-xl text-gray-700 bg-white border-gray-300 rounded transion ease-in-out mt-6" 
                    type="text" id="name" value={name} placeholder="Name" onChange={onChange}/>
           ...
           <div className="flex justify-between whitespace-nowrap text-sm sm:text-lg ">
            <p> have a account ? 
              <Link to="/sign-In" className="text-red-600 hover:text-red-800 ml-1">Sign In</Link>
              </p>
           ...
           <button type="submit" className="w-full  bg-blue-600 text-white hover:text-blue-800 mt-2 px-7 py-3 text-sm font-medium uppercase rounded
            shadow-md transion duration-150 ease-in-out hover:shadow-md active:bg-blue-900">Sign Up</button>
